...
public class SetsAssignmentsXMCDAv2 {
    ...
    private static void readFiles(XMCDA xmcda, XMCDA xmcda2, String indir) {
        convertToV3AndMark(new File(indir,  "alternatives.xml"), "alternatives", xmcda, "alternatives");
        convertToV3AndMark(new File(indir, "preferences_S.xml"), "preferences_S", xmcda, "alternativesComparisons");
        convertToV3AndMark(new File(indir, "preferences_Sc.xml"), "preferences_Sc", xmcda2, "alternativesComparisons");
    ...
    public static void main(String[] args) throws Utils.InvalidCommandLineException {
        ...
        final org.xmcda.XMCDA xmcda2 = new org.xmcda.XMCDA();
        readFiles(xmcda, xmcda2, indir);
        ...
        final Map<String, XMCDA> xResults = OutputsHandler.convert(results.getNetFlowScoreResults());
