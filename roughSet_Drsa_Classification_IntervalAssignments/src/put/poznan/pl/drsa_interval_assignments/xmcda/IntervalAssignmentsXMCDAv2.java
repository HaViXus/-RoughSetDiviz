...
import put.poznan.pl.drsa_interval_assignments.Main;

import java.io.File;
import java.util.Map;

public class IntervalAssignmentsXMCDAv2 {
    ...
    private static void readFiles(XMCDA xmcda, String indir) {
        ...
        convertToV3AndMark(new File(indir, "assignments.xml"), "alternativesAffectations", xmcda, "alternativesAffectations");
    ...
    public static void main(String[] args) throws Utils.InvalidCommandLineException {
        ...
        final Map<String, XMCDA> xResults = OutputsHandler.convert(results.getBestAssignments());
